...
class Turtle:
    def __init__(self, canvas, output_display):
        # Initialise the Turtle object with canvas and output_display
        self.canvas = canvas
        self.output_display = output_display

        # Create a turtle object for drawing shapes
        self.turtle = turtle.RawTurtle(canvas)
        self.turtle.speed(1)
        self.vertices = []  # To store shape vertices

        # Create a separate turtle object for drawing grid lines
    ...
    def execute_code(self, code):
        # Execute the provided code line by line
        lines = code.split('\n')
        for line in lines:
    ...
    def set_angle(self, angle):
        # Set the turtle's heading to the specified angle
    ...
    def draw_grid(self):
        ...
        self.grid_turtle.speed(0)   # Set the drawing speed to the fastest
        self.grid_turtle.pencolor('#e0e0e0')  # Set grid color to light gray 
        self.grid_turtle.pensize(1)  # Set pen size for grid lines
    ...
    def label_vertex(self, point, label):
        # Method to label a vertex and display its coordinates
        offset = 15
        self.turtle.penup()
    ...
    def triangles_match(self):
        # Check if the drawn triangle matches the random triangle
...
class AnglesInTriangles(tk.Frame):
    def __init__(self, master):
        ...
        # Label to display current coordinates
        ...
        # Label to display feedback on submitted answer
